...
--○ 데이터 입력(원격 접속 실습을 위한 준비 내용)
INSERT INTO TBL_MEMBERLIST(ID, PW, NAME, TEL, EMAIL)
VALUES('lsh', CRYPTPACK.ENCRYPT('java006$','lsh'), '이승희', '010-1111-8888', 'lsh@test.com');
-->한 줄 구성
INSERT INTO TBL_MEMBERLIST(ID, PW, NAME, TEL, EMAIL) VALUES('lsh', CRYPTPACK.ENCRYPT('java006$','lsh'), '이승희', '010-1111-8888', 'lsh@test.com')
;
--==>>1 행 이(가) 삽입되었습니다.
